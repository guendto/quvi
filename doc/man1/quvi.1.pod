...
=item B<--category-http> (depr.)

Enable category HTTP webscripts. This is the default category.
This option is deprecated and will be removed in later versions
of quvi. Use C<--category> instead.

=item B<--category-mms> (depr.)

Enable category MMS webscripts.
This option is deprecated and will be removed in later versions
of quvi. Use C<--category> instead.

=item B<--category-rtsp> (depr.)

Enable category RTSP webscripts.
This option is deprecated and will be removed in later versions
of quvi. Use C<--category> instead.

=item B<--category-rtmp> (depr.)

Enable category RTMP webscripts.
This option is deprecated and will be removed in later versions
of quvi. Use C<--category> instead.

=item B<--category-all> (depr.)
